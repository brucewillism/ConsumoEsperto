...
<<<<<<< HEAD
            ...
            if ("YOUR_MERCADOPAGO_CLIENT_SECRET".equals(newClientSecret) || 
                "CONFIGURAR_CLIENT_SECRET".equals(newClientSecret) ||
                newClientSecret == null || newClientSecret.trim().isEmpty()) {
                newClientSecret = currentConfig.getClientSecret(); // Manter o valor atual
