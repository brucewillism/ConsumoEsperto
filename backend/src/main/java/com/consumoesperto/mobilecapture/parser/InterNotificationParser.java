...
@Component
public class InterNotificationParser implements BankNotificationParser {
  ...
  public boolean supports(String packageName) {
    return packageName != null && packageName.toLowerCase().contains("inter");
  }

  @Override
  public String name() {
    return "InterNotificationParser";
  }
