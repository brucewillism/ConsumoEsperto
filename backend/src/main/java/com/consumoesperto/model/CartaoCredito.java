...
<<<<<<< HEAD
    ...
    public BigDecimal getLimiteUtilizado() { 
        if (limiteCredito != null && limiteDisponivel != null) {
            return limiteCredito.subtract(limiteDisponivel);
        }
        return BigDecimal.ZERO;
    }
    public void setLimiteUtilizado(BigDecimal limiteUtilizado) { 
        if (limiteCredito != null && limiteUtilizado != null) {
            this.limiteDisponivel = limiteCredito.subtract(limiteUtilizado);
        }
    }
